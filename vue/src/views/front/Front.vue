...
<!--    头部-->
    <div style="display: flex; height: 60px; line-height: 60px; border-bottom: 1px solid #eee">
      <div style="width: 300px; display: flex; padding-left: 30px">
        ...
        <div style="flex: 1">欢迎来到正能量系统</div>
      </div>
      <div style="flex: 1">
<!--        导航菜单-->
...
<!--        </ul>-->
        ...
        <el-menu :default-active="'1'" class="el-menu-demo" mode="horizontal" router>
          ...
          <el-menu-item index="/front/video">宣传视频</el-menu-item>
          <el-menu-item index="/front/article">我的申报</el-menu-item>
          <el-submenu index="2">
            <template slot="title">申报</template>
            ...
            <el-submenu index="2-4">
              <template slot="title">选</template>
...
<!--         <el-menu-item index="4"><a href="https://www.ele.me" target="_blank">订单管理</a></el-menu-item>-->
      ...
      <div style="width: 200px">
        <div v-if="!user.phoneNumber" style="text-align: right; padding-right: 30px">
